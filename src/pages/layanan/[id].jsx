        ...
        <div className="max-w-6xl mx-auto">
            <div className="flex flex-wrap justify-center gap-6 py-2">
                {items.map((text, idx) => (
                    <div
                        key={idx}
                        className="w-full md:w-[30%] min-h-[60px] bg-white rounded-2xl shadow-lg border border-slate-400 p-4 flex justify-center items-center transition-transform hover:-translate-y-1"
                    >
        ...
        <div className="relative w-full bg-white overflow-hidden font-['Poppins']">
                ...
                <div className="w-full bg-zinc-300 py-3 mb-4">
                    <div className="max-w-7xl mx-auto px-6 md:px-0">
                        <p className="text-zinc-800 text-base">
                            ...
                            <Link href="/layanan" className="hover:underline hover:text-green-600 transition-colors">
                                Layanan
                            </Link>
                            <span className="mx-2 text-zinc-500">{'>'}</span>
            ...
            <motion.section {...fadeInUp} className="max-w-[1440px] mx-auto px-6 md:px-20 py-12 flex flex-col lg:flex-row lg:items-center gap-10">
                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-center items-start gap-8">
                    ...
                    <div className="text-zinc-800 text-base font-normal leading-6 text-justify whitespace-pre-line">
                    ...
                    {reasons.map((item, index) => (
                        <div key={item.number} className="relative flex flex-col items-center text-center gap-5">
                            {index < reasons.length - 1 && (
                                <div
                                    className="hidden md:block absolute top-12 left-1/2 h-0.5 bg-zinc-300 z-0"
