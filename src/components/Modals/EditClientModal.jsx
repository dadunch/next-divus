        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div>
            ...
            <div
              ...
              className="relative w-full h-40 bg-gray-50 border-2 border-dashed border-gray-300 rounded-xl overflow-hidden flex items-center justify-center mb-3 cursor-pointer group hover:border-green-500 transition-colors"
            >
              {previewUrl ? (
                <div className="relative w-full h-full p-4">
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 bg-white p-1 rounded-full shadow-md hover:bg-red-50 text-red-500 transition-colors"
                  >
                    <X size={16} />
                  </button>
                </div>
      ...
      {cropModalOpen && (
        <div className="fixed inset-0 z-[60] bg-black/70 flex items-center justify-center">
          <div className="bg-white w-full max-w-md rounded-2xl overflow-hidden">
            <div className="relative w-full h-64 bg-gray-900/80 backdrop-blur-sm">
              <Cropper
                image={imageSrc}
                crop={crop}
                zoom={zoom}
