      ...
      <div className="px-8 pt-8 pb-10">
        ...
        <div className="grid grid-cols-12 gap-10">
          ...
          <div className="col-span-7 grid grid-cols-2 gap-10">
            <ImageBox label="Main Image 1" imgKey="img1" />
            <ImageBox label="Main Image 2" imgKey="img2" />
            <ImageBox label="Main Image 3" imgKey="img3" />
          </div>
          ...
          <div className="col-span-5">
            ...
            <div className="mt-10 flex justify-end">
              <button
                ...
                disabled={isSaving}
                className="flex items-center gap-2 bg-[#1E293B] hover:bg-black text-white px-8 py-3 rounded-lg font-medium transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1 disabled:opacity-60 disabled:cursor-not-allowed"
              >
                <Save size={18} />
